...
var roomList={0:{users:[]},1:{users:[]},2:{users:[]},3:{users:[]},4:{users:[]},5:{users:[]},6:{users:[]},7:{users:[]},8:{users:[]},9:{users:[]},10:{users:[]},
         11:{users:[]},12:{users:[]},13:{users:[]},14:{users:[]},15:{users:[]},16:{users:[]},17:{users:[]},18:{users:[]},19:{users:[]},20:{users:[]}};
// var users=[];
var connections=[];
var messages=[];
// var SOCKET_LIST = {};
